...
H01 = 10  ; S01 = SA ; L01 = 60  ; COL01 = [] ; ZIP01 = [] #col01
H02 = 10  ; S02 = SA ; L02 = 40  ; COL02 = [] ; ZIP02 = [] #col02

H03 = 55  ; S03 = SA ; L03 = 60  ; COL03 = [] ; ZIP03 = [] #col03
H04 = 55  ; S04 = SA ; L04 = 40  ; COL04 = [] ; ZIP04 = [] #col04

H05 = 120 ; S05 = SA ; L05 = 60  ; COL05 = [] ; ZIP05 = [] #col05
H06 = 120 ; S06 = SA ; L06 = 40  ; COL06 = [] ; ZIP06 = [] #col06

H07 = 150 ; S07 = SA ; L07 = 60  ; COL07 = [] ; ZIP07 = [] #col07
H08 = 150 ; S08 = SA ; L08 = 40  ; COL08 = [] ; ZIP08 = [] #col08

H09 = 220 ; S09 = SA ; L09 = 60  ; COL09 = [] ; ZIP09 = [] #col09
H10 = 220 ; S10 = SA ; L10 = 40  ; COL10 = [] ; ZIP10 = [] #col10

H11 = 280 ; S11 = SA ; L11 = 60  ; COL11 = [] ; ZIP11 = [] #col11
H12 = 280 ; S12 = SA ; L12 = 40  ; COL12 = [] ; ZIP12 = [] #col12

H13 = 330 ; S13 = SA ; L13 = 60  ; COL13 = [] ; ZIP13 = [] #col13
H14 = 330 ; S14 = SA ; L14 = 40  ; COL14 = [] ; ZIP14 = [] #col14

H15 = 240 ; S15 = 30 ; L15 = 60  ; COL15 = [] ; ZIP15 = [] #col15
H16 = 240 ; S16 = 30 ; L16 = 40  ; COL16 = [] ; ZIP16 = [] #col16
...
# Output
if xres is True:
    print('.post-content .btn-default {')
    print('	background-color:', HEX15+';')
    print('}')
    print('')
    print('.post-content .btn-default:hover {')
    print('	background-color:', HEX16+';')
    print('}')
    print('')

    print('.post-content .btn-red {')
    print('	background-color:', HEX01+';')
    print('}')
    print('')
    print('.post-content .btn-red:hover {')
    print('	background-color:', HEX02+';')
    print('}')
    print('')

    print('.post-content .btn-orange {')
    print('	background-color:', HEX03+';')
    print('}')
    print('')
    print('.post-content .btn-orange:hover {')
    print('	background-color:', HEX04+';')
    print('}')
    print('')

    print('.post-content .btn-green {')
    print('	background-color:', HEX05+';')
    print('}')
    print('')
    print('.post-content .btn-green:hover {')
    print('	background-color:', HEX06+';')
    print('}')
    print('')

    print('.post-content .btn-teal {')
    print('	background-color:', HEX07+';')
    print('}')
    print('')
    print('.post-content .btn-teal:hover {')
    print('	background-color:', HEX08+';')
    print('}')
    print('')

    print('.post-content .btn-blue {')
    print('	background-color:', HEX09+';')
    print('}')
    print('')
    print('.post-content .btn-blue:hover {')
    print('	background-color:', HEX10+';')
    print('}')
    print('')

    print('.post-content .btn-purple {')
    print('	background-color:', HEX11+';')
    print('}')
    print('')
    print('.post-content .btn-purple:hover {')
    print('	background-color:', HEX12+';')
    print('}')
    print('')

    print('.post-content .btn-pink {')
    print('	background-color:', HEX13+';')
    print('}')
    print('')
    print('.post-content .btn-pink:hover {')
